...
export const PASS29_MODULE_ASSETS = freezeList([
  ...
  {
    id: "broken_arch",
    src: "assets/v2/pass29/broken-arch.webp",
    type: "image/webp",
    layer: "midground",
    alpha: true,
    expectedWidth: 1586,
  ...
  {
    id: "foundry_pylon",
    src: "assets/v2/pass29/foundry-pylon.webp",
    type: "image/webp",
    layer: "midground",
    alpha: true,
    expectedWidth: 948,
  ...
  },
  {
    ...
    src: "assets/v2/pass29/foreground-rubble.webp",
    type: "image/webp",
    layer: "foreground",
    alpha: true,
    expectedWidth: 1736,
  ...
  {
    id: "route_girder",
    src: "assets/v2/pass29/route-girder.webp",
    type: "image/webp",
...
export function validatePass29ModularArt() {
  ...
  const checks = [
    ...
    { id: "runtime_formats", passed: PASS29_MODULE_ASSETS.every(asset => asset.type === "image/webp" || asset.type === "image/webp") },
    { id: "four_alpha_cutouts", passed: PASS29_MODULE_ASSETS.filter(asset => asset.alpha).length === 4 },
