...
export const PASS03_LEVEL = Object.freeze({
  ...
  exit: Object.freeze({ x: 4480, y: 3100 }),
  floors: Object.freeze([
    ...
    floor("exit_descent_a", 4210, 2410, 4300, 2490, 2),
    floor("exit_descent_b", 4300, 2490, 4380, 2790, 2),
    floor("exit_descent_c", 4380, 2790, 4480, 3100, 2),
    floor("pass03_exit", 4480, 3100, 4750, 3100, 2),
  ]),
...
export function validatePass03Level() {
  ...
  const checks = [
    ...
    { id: "pass03_exit_matches_blueprint", passed: level.exit.x === 4480 && level.exit.y === 3100 },
