...
export const PASS31_ENTRANCE_ASSETS = freezeList([
  ...
  {
    id: "entrance_arch",
    src: "assets/v2/pass31/entrance-arch.webp",
    type: "image/webp",
    layer: "midground",
    alpha: true,
    expectedWidth: 1150,
  ...
  {
    id: "shaft_tower",
    src: "assets/v2/pass31/shaft-tower.webp",
    type: "image/webp",
    layer: "midground",
    alpha: true,
    expectedWidth: 484,
  ...
  {
    id: "foreground_roots",
    src: "assets/v2/pass31/foreground-roots.webp",
    type: "image/webp",
    layer: "foreground",
    alpha: true,
    expectedWidth: 1810,
  ...
  {
    id: "route_stone",
    src: "assets/v2/pass31/route-stone.webp",
    type: "image/webp",
...
export function validatePass31EntranceArt() {
  ...
  const checks = [
    ...
    { id: "runtime_formats", passed: PASS31_ENTRANCE_ASSETS.every(asset => asset.type === "image/webp" || asset.type === "image/webp") },
